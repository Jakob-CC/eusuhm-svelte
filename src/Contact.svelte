                ...
                <form class="uk-form-stacked">
                    <div class="">
                        ...
                        <div class="uk-form-controls">
                            <input class="uk-input uk-border-rounded" id="contact-name" type="text" placeholder="Your Name">
                        </div>
                    </div>
                    <div class="uk-margin-small">
                        <label class="uk-form-label uk-text-muted " for="contact-email">Email</label>
                        <div class="uk-form-controls">
                            <input class="uk-input uk-border-rounded" id="contact-email" type="email" placeholder="yourname@email.com">
                        </div>
                    </div>
                    <div class="uk-margin-small">
                        <label class="uk-form-label uk-text-muted  " for="contact-message">Message</label>
                        <div class="uk-form-controls">
                            <textarea class="uk-textarea uk-border-rounded" id="contact-message" rows="5" placeholder="Your Message"></textarea>
                        </div>
                    </div>
                    <div class="uk-margin-small-top">
                        <button type="submit" class="uk-button uk-button-muted uk-button-large uk-width-1-1">Send Message</button>
                    </div>
                </form>
            </div>
             -->
