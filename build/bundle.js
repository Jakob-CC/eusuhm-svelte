...
var app = (function () {
    ...
    function create_each_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$4, 35, 16, 1230);
    			add_location(li, file$4, 35, 12, 1226);
    		},
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "target", /*target*/ ctx[2]);
    			attr_dev(a, "rel", "noopener");
    			add_location(a, file$4, 55, 16, 1961);
    			add_location(li, file$4, 55, 12, 1957);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, a);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav1, file$4, 43, 4, 1415);
    			attr_dev(div6, "class", "uk-visible@m");
    			add_location(div6, file$4, 42, 0, 1384);
    			attr_dev(div7, "class", "uk-padding");
    			add_location(div7, file$4, 63, 2, 2131);
    		},
    ...
    const file$3 = "src/Landing.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 31, 28, 1561);
    			attr_dev(div1, "class", "uk-form-controls");
    			add_location(div1, file$1, 30, 24, 1502);
    			attr_dev(div2, "class", "");
    			add_location(div2, file$1, 28, 20, 1363);
    			attr_dev(label1, "class", "uk-form-label uk-text-muted ");
    			attr_dev(label1, "for", "contact-email");
    			add_location(label1, file$1, 35, 24, 1790);
    			...
    			add_location(section, file$1, 1, 0, 25);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			button = element("button");
    			t3 = text(/*content1*/ ctx[0]);
    			t4 = space();
    			create_component(footer.$$.fragment);
    			add_location(button, file, 16, 0, 275);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*onClick*/ ctx[1], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*content1*/ 1) set_data_dev(t3, /*content1*/ ctx[0]);
    		},
