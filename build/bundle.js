...
var app = (function () {
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a = element("a");
    			t = text(t_value);
    			attr_dev(a, "href", "img/eusuhm_logo_text.svg");
    			attr_dev(a, "target", /*target*/ ctx[2]);
    			attr_dev(a, "rel", "noopener");
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div7, file$5, 63, 2, 2194);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			div.textContent = "Hello Submit";
    			attr_dev(div, "class", "submit-container uk-card uk-card");
    			add_location(div, file$1, 1, 0, 27);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 39, 2, 792);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope*/ 8) {
    				submit_changes.$$scope = { dirty, ctx };
    			}
